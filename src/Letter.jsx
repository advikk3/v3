...
const Letter = ({ onMoreSurprises, onBack }) => {
  ...
  "Happy Valentine’s Day, my loveeee 💖",
  "",
  "It’s Valentine’s Day and I miss you a lottt.",
  "Even though we can’t meet today,",
  "it’s okay…",
  "",
  "We can see each other on Monday in school, right? 🥺",
  "",
  "I love you so much, my lovee.",
  "",
  "You are my favourite forever.",
  "You are always there for me,",
  "in my lowest lows and my highest highs.",
  "",
